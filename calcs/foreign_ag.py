...
additional_foreign = ["Subsidiary of the Hu family's YK Group",'YK Group''Clean Agriculture and International Tourism','Clean Agriculture & International Tourism', 'Australian Agricultural Company', 'Ruyi Group (China)', 'Ruyi Group', "Zenith (Australia) Investment Holding Pty Ltd", 'Yiang Xiang Assets', 'Clean Agriculture and International Tourism', 'Ma Xingfa', 'Cross Pacific Investment', 'Pham Nhat Vu']
...
gdf.loc[gdf['Owner'].isin(strayan), 'Who'] = "Australian"
gdf.loc[gdf['Owner'].isin(foreign), 'Who'] = "Foreign"

grouped = gdf.groupby(by="Who")['Area'].sum().reset_index()
